...
import { fetchKeyStat, fetchCompany, fetchPrevPrice, fetchHistory, fetchNews } from "../services/fetchData";
import Graph from "../ui-kit/Graph";
    ...
    <div className="home-page">
      ...
      <div className="dropdown">
          <select onChange={e => onClickSearch(e.target.value)} className="select">
            <option defaultValue value="" key="don't">Please Select Stock</option>
            {STOCK_LIST.map((data, index) => <option value={data.symbol} key={index}>{data.name}</option>)}
          </select>
      </div>
